...
% Plot the energy values for both sets
figure;
subplot(3, 1, 1);
plot(time, E_bath_total_1, 'r', 'DisplayName', 'Set 1 - E-bath-total');
hold on;
plot(time, E_bath_total_2, 'b', 'DisplayName', 'Set 2 - E-bath-total');
xlabel('Data Point Index');
ylabel('Energy (eV)');
title('E-bath-total Comparison');
legend('Location', 'Northwest');
grid on;

subplot(3, 1, 2);
plot(time, E_clk_total_1, 'r', 'DisplayName', 'Set 1 - E-clk-total');
hold on;
plot(time, E_clk_total_2, 'b', 'DisplayName', 'Set 2 - E-clk-total');
xlabel('Data Point Index');
ylabel('Energy (eV)');
title('E-clk-total Comparison');
legend('Location', 'Northwest');
grid on;

subplot(3, 1, 3);
plot(time, E_Error_total_1, 'r', 'DisplayName', 'Set 1 - E-Error-total');
hold on;
plot(time, E_Error_total_2, 'b', 'DisplayName', 'Set 2 - E-Error-total');
xlabel('Data Point Index');
ylabel('Energy (eV)');
title('E-Error-total Comparison');
legend('Location', 'Northwest');
grid on;
